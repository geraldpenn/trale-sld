...
public class TraleSldController implements ActionListener, ItemListener, MouseListener, WindowListener
{
	...
	public void actionPerformed(ActionEvent event)
	{
		...
		/*
		 * else if (cmd.equals("Abort")) { setButtonActivationMode(ABORTED);
		 * pressedButton = "abort"; }
		 */
	...
	public void mouseClicked(MouseEvent e)
	{
		...
		} else if (o == gui.localTreeButton)
		{
			...
			{
				gui.detailPanel.setSelectedComponent(gui.localTreeTab);
			}
		}
	}
	...
	public void windowClosing(WindowEvent e)
	{
		...
		{
			int index = gui.detailPanel.getTabCount();
			gui.detailPanel.insertTab("Variables", null, gui.variablesPanel, null, index);
			gui.detailPanel.setTabComponentAt(index, gui.variableButton);
		...
		{
			gui.detailPanel.insertTab("Local tree", null, gui.createLocalTreeTab(gui.localTreePanel), null, 0);
			gui.detailPanel.setTabComponentAt(0, gui.localTreeButton);
		}
	}
